...
//        self.buttonProName = [UIButton buttonWithFrame:CGRectMake(0 + SCREEN_WIDTH / 10 * i, 5, SCREEN_WIDTH / 10 - 2, 40) title:self.proNameArray[i] backGroudImage:nil target:self action:@selector(inputBelongingAddress1:)];
        
        self.buttonProName = [MyControl creatButtonWithFrame:CGRectMake(0 + SCREEN_WIDTH / 10 * i, 5, SCREEN_WIDTH / 10 - 2, 40) target:self sel:@selector(inputBelongingAddress1:) tag:i+10 image:nil title:self.proNameArray[i]];
...
//    self.buttonInputAgain = [UIButton buttonWithFrame:CGRectMake(10, 0, 40, 35) title:@"重输" backGroudImage:nil target:self action:@selector(inputAgainChars1:)];
    
    self.buttonInputAgain = [MyControl creatButtonWithFrame:CGRectMake(10, 0, 40, 35) target:self sel:@selector(inputAgainChars1:) tag:1 image:nil title:@"重输"];
    ...
    // 删除按钮
//    self.buttonDelete = [UIButton buttonWithFrame:CGRectMake(SCREEN_WIDTH - 35, 5, 30, 20) title:nil backGroudImage:@"delete_icon_nor" target:self action:@selector(deleteChars1:)];
    
    self.buttonDelete = [MyControl creatButtonWithFrame:CGRectMake(SCREEN_WIDTH - 35, 5, 30, 20) target:self sel:@selector(deleteChars1:) tag:2 image:@"delete_icon_nor" title:nil];
     ...
     */
    for (NSInteger i = 0; i < 10; i ++) {
//        self.buttonCharsAndNum = [UIButton buttonWithFrame:CGRectMake(0 + SCREEN_WIDTH / 10 * i, 5, SCREEN_WIDTH / 10 - 2, 40) title:self.charsAndNumArray[i] backGroudImage:nil target:self action:@selector(inputChars1:)];
        self.buttonCharsAndNum = [MyControl creatButtonWithFrame:CGRectMake(0 + SCREEN_WIDTH / 10 * i, 5, SCREEN_WIDTH / 10 - 2, 40) target:self sel:@selector(inputChars1:) tag:i+100 image:nil title:self.charsAndNumArray[i]];
